...
Maze::Maze(float height, float width)
{
    ...
    for (int a = 0; a < 2; a++)
        for (int b = 0; b < 2; b++)
        {
            ...
            vert1 = glm::vec3(X_large[a] - side / 2.0f, Y_large[b] - side / 2.0f, 0.0f);
            vert2 = glm::vec3(X_large[a] - side / 2.0f, Y_large[b] + side / 2.0f, 0.0f);
            vert3 = glm::vec3(X_large[a] + side / 2.0f, Y_large[b] + side / 2.0f, 0.0f);
            vert4 = glm::vec3(X_large[a] + side / 2.0f, Y_large[b] - side / 2.0f, 0.0f);
            this->createSquare(vert1, vert2, vert3, vert4, vec);
        }
